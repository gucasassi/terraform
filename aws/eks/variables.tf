...
variable "cluster_version" {
  description = "The desired Kubernetes version for the EKS cluster. If you do not specify a value, the latest available version is used."
  type        = string
  default     = null
}
...
variable "vpc_id" {
  type        = string
  description = "The ID of the VPC in which to create the EKS cluster. Use the VPC ID as a reference in other modules or resources requiring VPC identification."
}
